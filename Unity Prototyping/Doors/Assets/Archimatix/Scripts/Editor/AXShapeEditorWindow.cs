       ...
       // GUIDrawing.drawSquare(Vector2.zero, 30);
        ...
        if (currentShapePO != null && currentShapePO.is2D())
        {
            ...
            if (outShape_p != null)
            {
                ...
                //Vector3[] verts3d = AXGeometryTools.Utilities.path2Vec3s(outpaths[0], Axis.Z, (outShape_p.shapeState == ShapeState.Closed));
                Vector2[] verts2D = AXGeometryTools.Utilities.path2Vec2s(outpaths[0]);
