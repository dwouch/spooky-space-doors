...
//			}
		...
		public IntPoint getLocalAlignShifterForPaths(Paths paths)
		{
			...
			//if (alignX != 0)
				//shift_x += transX*AXGeometryTools.Utilities.IntPointPrecision;
			//if (alignY != 0)
			//	shift_y += transY*AXGeometryTools.Utilities.IntPointPrecision;
...
//			float cen_y = b.center.y;
	...
	public class Generator3D : AX.Generators.Generator
	{
		...
		public override Vector3 getLocalAlignShifter()
		{
			...
			Axis axis =  (P_Axis != null) ? (Axis) P_Axis.intval : Axis.NONE;
