...
namespace AXGeometryTools
{
	...
	public class Spline 
	{
		...
		public Spline(Path path, bool _isClosed, float breakP, float breakN, bool _trueSideSection = true)
		{
			isClosed 			= _isClosed;
		...
		public Matrix4x4 matrixAtLength(float len) 
		{
			...
			// Note: The negative length needs to be treated differently in opena nd closed shapes.
